...
This repository contains the introductions to the datasets and codes used in our paper, titled "Few-Shot Open-Set Audio Classification Using Attention Information-Fused Prototypes" .
...
## Contact
Yanxiong Li (eeyxli@scut.edu.cn) and Jiaxin Tan ()
